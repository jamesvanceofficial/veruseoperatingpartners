    ...
    <div className="flex flex-col">
      <section className="page-container flex flex-col items-center gap-6 py-16 text-center sm:py-24">
        ...
        <p className="max-w-2xl text-[14.5px] leading-relaxed text-[var(--muted)]">
          Every build is bundled with an ongoing subscription that keeps it running, keeps it current as the business changes, and keeps
          your team actually using it. Pulled directly from the same tier structure your build recommendation is scoped from — nothing
          here can drift from what you&apos;d actually see.
        </p>
      </section>

      <section className="page-container flex flex-col gap-6 pb-16 sm:pb-20">
        {SUPPORT_TIERS.filter((t) => t !== "custom").map((tier) => {
      ...
      <section className="border-t border-[var(--hairline)] bg-[var(--surface)]">
        <div className="page-container flex flex-col items-center gap-6 py-16 text-center sm:py-20">
          ...
          <p className="max-w-xl text-[13.5px] leading-relaxed text-[var(--muted)]">
            Your recommended tier and price are part of your build recommendation — matched to your team size and how much ongoing work
            the assessment found you actually need.
          </p>
