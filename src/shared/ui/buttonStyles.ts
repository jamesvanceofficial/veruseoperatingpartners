...
export function buttonClassName({
  ...
  return cn(
    ...
    variant === "primary" &&
      "glow-gold-hover glow-gold-idle border border-[color-mix(in_srgb,var(--gold)_55%,transparent)] bg-gradient-to-b from-[var(--gold-light)] to-[var(--gold)] text-[var(--black)]",
